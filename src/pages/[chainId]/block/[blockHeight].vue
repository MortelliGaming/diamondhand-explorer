        ...
        <div v-else  style="width: 100%; height: 100%;">
            ...
            <div v-else class="fill-height">
                <div v-if="block">
                    ...
                    <base-sheet :title="$t('blocks.lastBlockSignatures')" class="pt-5" style="height:100%;">
                        <v-container class="pa-0 mt-2" style="height: 160px; overflow-y: scroll;">
                            <v-row class="pt-3">
                                <v-col cols="12" sm="4" md="3" v-for="signature in block.block.lastCommit?.signatures" :key="signature.validatorAddress?.toString()">
                                    <v-sheet
